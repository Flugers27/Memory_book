...
class UserRole(Base):
    ...
    permissions = Column(JSONB, nullable=False, default={"edit_own": True, "create_page": True, "view_public": True})
...
class User(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'avatar_id': str(self.avatar_id) if self.avatar_id else None,
        }
...
class RefreshToken(Base):
    ...
    user_id = Column(UUID(as_uuid=True), ForeignKey('users.id_user'), nullable=False, index=True, unique=True)
